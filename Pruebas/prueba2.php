...
<h1>INTEGRACIÓN POR CURVATURA GAUSSIANA</h1>


<body>

  <form action="prueba2.php" method="POST" name="INTEGRACIÓN POR CURVATURA GAUSSIANA">
  <br><b>Ingrese la función a integrar: </b><input type="int" name="txt_funcion" value="1" step="0.01"/><br>
