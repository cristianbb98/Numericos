...
<section>
	<div>
		...
		<table align="center">
			...
			<tr align = "center" >
				<div align = "center" class = "encabezado"><b>INTEGRACIÓN POR CURVATURA GAUSSIANA</b></div>
			</tr>
		</table>
    </div>
					...
					<?php
						if(isset($_POST['btn_calcular'])){
							...
							if(isset($_POST['btn_calcular'])){
								...
								echo "<a href='procedimientos.php ?funcion=".urlencode($funcion)."&inf=" . $intervalo_Inferior . "&sup=" . $intervalo_Superior . "&n=" . $n ."&metodo=".$metodo. "' class = 'button' target='_parent' onclick=\"window.open(this.href, this.target, width=800, height=800, menubar=no');return false;\"> Ver Procedimientos </a>";
								echo "<br>";
								echo "</div>";
							}	
						}
